...
class _HomeScreenState extends State<HomeScreen> {
    ...
    if (mounted) {
      setState(() {
        ...
        if (cities.isNotEmpty) {
          ...
          if (cities.length > 1) {
            villeArrivee = cities.first == villeDepart
                ? cities[1]
                : cities.first;
          }
        }
                  ...
                  child: Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        _buildCircleBtn("assets/images/paper.png", () {
                          // Accès direct aux résultats (sans recherche précise)
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) =>
                                  const SearchResultsScreen(isGuestMode: true),
                            ),
                          );
                        }, circleBtnColor),
                      ],
                              ...
                              children: [
                                Expanded(
                                  child: _buildCitySelector(
                                    assetPath:
                                        "assets/images/map.png", // Ajoute ton image ici
                                    label: "Départ",
                          ...
                          Expanded(
                            child: InkWell(
                              ...
                              child: _buildInputBoxUI(
                                imagePath:
                                    "assets/images/agenda.png", // CORRIGÉ
                                label: "Date départ",
                                value: dateDisplay,
                                textColor: mainTextColor,
                                subTextColor:
                                    subTextColor, // CORRIGÉ (subColor -> subTextColor)
                                borderColor: borderColor,
                              ),
                            ),
                          ),
                          ...
                          Row(
                            children: [
                              Checkbox(
                                ...
                                onChanged: (v) =>
                                    setState(() => isAllerRetour = v ?? false),
                              ),
                              Text(
                                "Aller-retour",
                                style: TextStyle(
        ...
        return StatefulBuilder(
          builder: (context, setStateModal) {
            ...
            return Padding(
              ...
              child: SafeArea(
                // 🟢 NOUVEAU : Protège contre la barre de navigation système
                child: Padding(
                  padding: const EdgeInsets.only(
                    left: 20,
                    right: 20,
                    top: 20,
                    bottom: 10, // 🟢 Marge interne basique
                  ),
                  child: Column(
                    ...
                    children: [
                      ...
                      // --- CHAMP TEXTE ---
                      const Text(
                        "Décrivez la situation (gravité, lieu, véhicules) :",
                        style: TextStyle(
                          fontSize: 13,
                        ...
                        Stack(
                          children: [
                            ...
                            Positioned(
                              ...
                              child: InkWell(
                                onTap: () =>
                                    setStateModal(() => selectedPhoto = null),
                                child: Container(
                        ...
                        children: [
                          Expanded(
                            child: OutlinedButton.icon(
                              onPressed:
                                  _showImageSourceOptions, // 📸 Action activée
                              icon: Icon(
                                selectedPhoto == null
                                    ? Icons.camera_alt
                                    : Icons.check_circle,
                          ...
                          Expanded(
                            child: OutlinedButton.icon(
                              onPressed: () {
                                _showTopNotification(
                                  context,
                                  "📍 Localisation automatique activée lors de l'envoi.",
                                );
                              },
                              icon: const Icon(
                                Icons.location_on,
                          ...
                          onPressed: isSubmitting
                              ...
                              : () async {
                                  ...
                                  try {
                                    ...
                                    _showTopNotification(
                                      context,
                                      "✅ Signalement envoyé aux secours. Merci de votre aide !",
                                    );
                                  } catch (e) {
  ...
  Widget _buildCitySelector({
    ...
    return Container(
      padding: const EdgeInsets.symmetric(
        horizontal: 12,
        vertical: 8,
      ), // Un peu plus d'espace vertical
      decoration: BoxDecoration(
        border: Border.all(color: borderColor),
        borderRadius: BorderRadius.circular(12), // Arrondi un peu plus moderne
      ),
      child: Row(
        // 2. ON UTILISE UNE ROW POUR METTRE L'IMAGE À GAUCHE
        children: [
          // --- L'IMAGE ---
          Image.asset(
            assetPath,
          ...
          Expanded(
            // Important : Expanded permet au texte de prendre toute la place restante
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              ...
              children: [
                ...
                ), // Police un peu plus grande (10 -> 12)
                ...
                DropdownButtonHideUnderline(
                  child: DropdownButton<String>(
                    ...
                    isExpanded: true,
                    isDense:
                        true, // Réduit la hauteur interne du dropdown pour mieux s'aligner
                    hint: Text(
                      "Choisir",
                    ...
                    icon: Icon(
                      ...
                      color: isGreen
                          ? Colors.green
                          : Colors.grey, // Utilise tes couleurs ici
                    ),
  ...
  Widget _buildInputBoxUI({
    required String
    imagePath, // J'ai renommé 'icon' en 'imagePath' pour correspondre à ton appel
    required String label,
    required String value,
    required Color textColor,
