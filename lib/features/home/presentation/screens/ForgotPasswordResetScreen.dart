        ...
        return AlertDialog(
          ...
          content: Column(
            ...
            children: [
              ...
              const Gap(20),
              Text("Félicitations !", style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold, color: textColor)),
              const Gap(10),
              Text(
                "Votre mot de passe a été réinitialisé avec succès. Vous pouvez maintenant vous connecter.",
                textAlign: TextAlign.center,
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Text("Réinitialisation", style: TextStyle(fontSize: 28, fontWeight: FontWeight.bold, color: textColor)),
            const Gap(10),
            Text("Votre identité est confirmée. Créez votre nouveau mot de passe sécurisé.", style: TextStyle(color: secondaryTextColor, fontSize: 14)),
            const Gap(40),
