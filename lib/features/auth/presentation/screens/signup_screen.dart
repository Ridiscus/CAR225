  ...
  Future<void> _handleRegister() async {
    ...
    if (_nomController.text.isEmpty ||
      ...
      _showTopNotification(
        "Tous les champs sont obligatoires sauf le email",
        isError: true,
      );
      return;
    }
    ...
    try {
      ...
      if (response.success) {
        if (response.requiresOtp) {
          // 🚨 REDIRECTION OTP
          print(
            "📲 [REGISTER OTP] Redirection vers l'écran de vérification...",
          );
                ...
                child: ElevatedButton(
                  ...
                  style: ElevatedButton.styleFrom(
                    ...
                    disabledBackgroundColor: Colors
                        .transparent, // Important pour voir l'image quand _isLoading est true
