...
import 'hostess_scan_result_screen.dart';
import '../../../../core/theme/app_colors.dart';

class HostessScannerScreen extends StatefulWidget {
  const HostessScannerScreen({super.key});

  @override
  State<HostessScannerScreen> createState() => _HostessScannerScreenState();
}

class _HostessScannerScreenState extends State<HostessScannerScreen>
  ...
  void _navigateToResult(String code) async {
    ...
    await Navigator.push(
      context,
      CupertinoPageRoute(
        builder: (context) => HostessScanResultScreen(ticketReference: code),
      ),
    );
