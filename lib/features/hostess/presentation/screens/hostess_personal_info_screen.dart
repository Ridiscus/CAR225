    ...
    return Column(
      ...
      children: [
        ...
        TextFormField(
          ...
          enabled: false,
          style: const TextStyle(
            color: Color(0xFF90A4AE), // Couleur plus claire
            fontWeight: FontWeight.w600,
            fontSize: 16,
          ),
          decoration: InputDecoration(
            ...
            children: [
              ...
              Center(
                child: Container(
                  ...
                  child: CircleAvatar(
                    radius: 54, // Correspond à ton ancien width/height 120 environ
                    backgroundColor: const Color(0xFFF5F5F5),
                    backgroundImage: pickedImage != null
                        ? FileImage(pickedImage)
                        : (cleanImageUrl.isNotEmpty
                        ? NetworkImage(cleanImageUrl)
                        : const AssetImage('assets/images/hostess_profile.png') as ImageProvider),

                    onBackgroundImageError: (exception, stackTrace) {
                      print("⚠️ Erreur image InfoScreen : $exception");
                    },
                  ),
                ),
              ),
