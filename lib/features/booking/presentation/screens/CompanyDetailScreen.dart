                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      TextButton(
                        ...
                        child: const Text("Fermer", style: TextStyle(color: Colors.redAccent, fontWeight: FontWeight.bold)),
                      )
                    ],
                  ),
                  const Gap(10),
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      color: cardColor, // Fond du container si l'image charge mal
                  ...
                  Text("Trajets actifs", style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: textColor)),
                  const Gap(15),
        ...
        children: [
          ...
          Column(
            ...
            children: [
              Row(
                children: [
                  Text(origin, style: TextStyle(fontWeight: FontWeight.bold, fontSize: 14, color: textColor)),
                  Padding(
                    padding: const EdgeInsets.symmetric(horizontal: 8.0),
                    child: Icon(Icons.arrow_right_alt, size: 16, color: isDark ? Colors.grey[400] : Colors.grey),
                  ),
                  Text(destination, style: TextStyle(fontWeight: FontWeight.bold, fontSize: 14, color: textColor)),
                ],
              ),
              const Gap(2),
              Text(label, style: TextStyle(color: isDark ? Colors.grey[500] : Colors.grey, fontSize: 11)),
            ],
          ),
          const Spacer(),
          Container(
