...
class _HomeScreenState extends State<HomeScreen> {
          ...
          children: [
            ...
            Stack(
              children: [
                ...
                // Boutons du haut (Profil + Ticket) -> Redirigent vers Login car invité
                SafeArea(
                  child: Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        // PROFIL -> Login
                        _buildCircleBtn("assets/images/user.png", () => _goToLogin(context)),

                        // TICKET -> SearchResultsScreen (Mode Invité)
                        InkWell(
                          onTap: () {
                            // MODIFICATION ICI : On va vers les résultats au lieu du login
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => const SearchResultsScreen(
                                  isGuestMode: true, // <--- On active le mode invité
                                ),
                              ),
                            );
                          },
              ...
              child: Padding(
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      const Text("Où souhaitez-vous voyager ?", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
                      const Text("Réservez votre billet en quelques clics", style: TextStyle(color: AppColors.grey, fontSize: 12)),
                      const Gap(20),
                      ...
                      Row(
                        children: [
                          Expanded(
                              child: _buildInputBox("assets/images/map.png", "Départ", "Abidjan")
                          ),
                          const Gap(10),
                          Expanded(
                              child: _buildInputBox("assets/images/map.png", "Arrivée", "Yamoussoukro", isGreen: true)
                          ),
                        ],
                      ),
                      const Gap(15),

                      // --- MODIFICATION ICI : Date + Checkbox sur la même ligne ---
                      Row(
                        crossAxisAlignment: CrossAxisAlignment.center, // Aligne verticalement au centre
                        children: [
                          // 1. La Date (Prend l'espace restant)
                          Expanded(
                            child: _buildInputBox("assets/images/agenda.png", "Date départ", "Ven. 30 Jan"),
                          ),

                          const Gap(10), // Petit espace entre la date et la checkbox

                          // 2. La Checkbox (Prend juste la place nécessaire)
                          Row(
                            ...
                            children: [
                              Checkbox(
                                ...
                                materialTapTargetSize: MaterialTapTargetSize.shrinkWrap, // Réduit la zone de clic "vide" autour
                                visualDensity: VisualDensity.compact, // Rend la checkbox plus compacte
                              ...
                              const Gap(4),
                              const Text("Aller-retour", style: TextStyle(fontSize: 13, fontWeight: FontWeight.w500)),
                            ],
                          ),
                        ],
                      ),

                      const Gap(20), // Un peu plus d'espace avant le bouton
                      ...
                      SizedBox(
                        ...
                        child: ElevatedButton(
                          onPressed: () {
                            // REDIRECTION VERS SEARCH AVEC MODE INVITÉ ACTIVÉ
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => const SearchResultsScreen(
                                  isGuestMode: true, // <--- C'est ça qui change tout !
                                ),
                              ),
                            );
                          },
                ...
                child: Column(
                  children: [
                    ...
                    SizedBox(
                      ...
                      height: 50,
                      child: ElevatedButton(
                        onPressed: () => _goToLogin(context), // Ici on envoie direct au Login, c'est logique
                        style: ElevatedButton.styleFrom(
  ...
  // Helper : Bouton Rond Header
  Widget _buildCircleBtn(String imagePath, VoidCallback onTap) {
    return InkWell(
      onTap: onTap,
      child: Container(
  ...
  Widget _buildInputBox(String imagePath, String label, String value, {bool isGreen = false}) {
    return Container(
