...
class AuthRepositoryImpl implements AuthRepository {
  ...
  Future<HostessProfileModel> updateProfile(Map<String, dynamic> data) async {
    try {
      // On fait simplement le pont : on demande au remoteDataSource de faire le travail
      final updatedProfile = await remoteDataSource.updateProfile(data);
      return updatedProfile;
    } catch (e) {
      // On relance l'erreur pour que le Provider puisse l'attraper et l'afficher
      rethrow;
    }
  }
  ...
  Future<void> changePasswordHotesse(Map<String, dynamic> data) async {
    try {
      // Assure-toi que la méthode dans ton remoteDataSource s'appelle aussi changePasswordHotesse
      // Sinon, remplace par le nom que tu lui as donné (ex: changePassword)
