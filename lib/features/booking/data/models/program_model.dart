...
class ProgramModel {
  ...
  factory ProgramModel.fromJson(Map<String, dynamic> json) {
    ...
    final int placesDispoCalculated = (placesTotal - placesOccup) < 0
        ? 0
        : (placesTotal - placesOccup);
    ...
    String dateRaw =
        json['date_depart'] ?? DateTime.now().toString().split(' ')[0];
    ...
    return ProgramModel(
      ...
      placesDisponibles: json['places_disponibles'] != null
          ? (int.tryParse(json['places_disponibles'].toString()) ??
