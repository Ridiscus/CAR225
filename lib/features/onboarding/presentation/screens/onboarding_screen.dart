  ...
  final List<Map<String, dynamic>> _content = [
    {
      ...
      "title": "Le voyage simplifié\npartout en Côte d'Ivoire",
      "desc":
          "Profitez d'un réseau national complet, du confort moderne et du Wi-Fi à bord.",
    },
    {
      "image": "assets/images/onboarding_processs.png",
      "title": "Réservez en\nquelques clics",
      "desc":
          "Trouvez et réservez vos billets de bus avec nos compagnies partenaires fiables.",
    },
    {
      "image": "assets/images/onboarding_seat.png",
      "title": "Votre place,\nvotre confort",
      "desc":
          "Choisissez votre siège. Profitez d'un espace dédié pour un voyage paisible.",
    },
    {
      "image": "assets/images/onboarding_relax.png",
      "title": "Gagnez du temps,\nSoyez Smart",
      "desc":
          "Votre temps est précieux. Ne le perdez plus jamais dans une file d'attente.",
    },
  ];
