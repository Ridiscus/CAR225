...
import 'package:provider/provider.dart'; // N'oublie pas l'import de Provider
import 'package:car225/core/theme/app_colors.dart';
import '../providers/agent_profile_provider.dart';
import "../widgets/custom_app_bar.dart";
import "../widgets/success_modal.dart";
// 🟢 Ajoute ici l'import de ton provider, par exemple :
// import '../providers/agent_profile_provider.dart';
...
class _AgentChangePasswordScreenState extends State<AgentChangePasswordScreen> {
  ...
  void _handleSubmit() async {
    // On réinitialise l'erreur d'affichage
    ...
    // 🟢 VRAI APPEL API VIA LE PROVIDER
    final provider = context.read<AgentProfileProvider>(); // Adapte le nom de ton Provider si besoin
    ...
    // Si c'est un succès (HTTP 200/201)
    if (result['success'] == true) {
      SuccessModal.show(
        ...
        onPressed: () {
          ...
          //Navigator.pop(context); // Quitte l'écran de changement de mdp
        },
      );
    } else {
      // 🟢 Si le backend renvoie une erreur (ex: mauvais mot de passe)
      setState(() {
        _oldPasswordError = result['message'];
      });
      // Force le formulaire à se redessiner pour afficher le message en rouge
                    ...
                    children: [
                      ...
                      _buildPasswordField(
                        ...
                        validator: (value) {
                          ...
                          // 🟢 Affiche l'erreur de l'API ici (si le provider a renvoyé success: false)
